                    ...
                    <tr <?= $bg ?>>
                        ...
                        <td>
                            <?php if ($commande->statut == 'En attente'): ?>
                                <form method="post" action="<?= site_url('commandes/demarrer_preparation/' . $commande->id_commande) ?>" style="display:inline-block">
                                    <button type="submit" class="btn btn-sm btn-success">Démarrer</button>
                                </form>
                            <?php elseif ($commande->statut == 'En préparation'): ?>
                                <form method="post" action="<?= site_url('commandes/valider_preparation/' . $commande->id_commande) ?>" style="display:inline-block">
